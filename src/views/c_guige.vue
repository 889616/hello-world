      ...
      <van-row>
        ...
        <van-col span="22">
          ...
          <div style="margin:5px 0;">
            ...
            <van-button type="default" @click="add()" style="height:22px;line-height:20px">选择</van-button>
          </div>
          <!-- 颜色选择 -->
          <div style="width:100%;height:45px;margin:5px 0;">
            <p style="margin:10px 0;">颜色</p>
