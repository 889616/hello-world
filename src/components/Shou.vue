...
<template>
	<div class="box">	
		...
		<img style="width:100%;height:150px;margin-top:45px;" src="../assets/96.jpg"/>
        </div>
		
		<!-- 中部 -->
		<section style="">
		<p style="text-indent:20px;font-size:14px;padding:10px">酒酿(sweet ferment rice )，旧时叫“醴”，是中国传统的特产酒。用蒸熟的江米（糯米）拌上酒酵（一种特殊的微生物酵母）发酵而成的一种甜米酒在我国全国各地称呼不同又叫醪糟、酒酿、米酒、甜酒、甜米酒、糯米酒、江米酒、酒糟。</p>
...
<style scoped>
ul li{font-size:12px;padding: 10px 0;border-bottom:1px solid #cecece;}
